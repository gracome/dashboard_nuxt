        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="javascript:void(0)">
              {{
                $store.state.selectedUser.id === $store.state.currentUser?.id
                  ? "Me"
                  : $store.state.selectedUser.display_name ||
                    $store.state.selectedUser.first_name +
                      " " +
                      $store.state.selectedUser.last_name
              }}
            </a>
          </li>
        </ol>
...
import detailsUserComp from "@/components/users/userDetailComp.vue";
export default {
